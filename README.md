...
[PyPI](https://pypi.org/project/dataevolver/)
[FastAPI](https://fastapi.tiangolo.com/)
[React](https://react.dev/)
[Paper](assets/DataEvolver.pdf)
[License](LICENSE)
...
|                                                     |                                                   |                                                |
| --------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------- |
| **~12%** avg relative gain vs. weaker prep settings | **7** benchmarks instruction · MC-QA · math · SQL | **~40%** lower amortized token cost on average |
...
*Downstream performance across 7 benchmarks from 4 task categories (instruction following, MC-QA, math reasoning, text-to-SQL).*



*DataEvolver vs. vanilla SFT on raw data and strong data-prep baselines — fewer, better-prepared samples can match or exceed larger weakly-prepared alternatives.*

**Ablation & case study (click to expand)**
...
▶ **[Watch full demo](https://github.com/Akanezora0/DataEvolver/raw/main/assets/demo.mp4)** (2m50s) · [Download HD .mov](https://github.com/Akanezora0/DataEvolver/releases/download/demo-2026-04-18/DataEvolver_Demo_small.mov)
...
| HTTP API     | [http://127.0.0.1:8000](http://127.0.0.1:8000)           |
...
| ------------ | ------------------------------------------ | ---------------------------------------------- |
| **Web UI**   | Exploration, visual DAG & trial inspection | `http://127.0.0.1:5173`                        |
...
Interactive schema: [http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs)
